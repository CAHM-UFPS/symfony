...
class getDoctrineMongodb_Odm_PsrCommandLoggerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['doctrine_mongodb.odm.psr_command_logger'] = new \Doctrine\Bundle\MongoDBBundle\APM\PSRCommandLogger(($container->privates['monolog.logger.doctrine'] ?? $container->load('getMonolog_Logger_DoctrineService')));
    }
}
